        ...
        <div className="glass rounded-3xl p-8 border border-white/10 shadow-soft">
          ...
          <div className="flex flex-col gap-3">
            ...
            <button
              ...
              disabled={isLoading !== null}
              className="w-full h-14 flex items-center justify-center gap-3 rounded-2xl bg-[#06C755]/60 hover:bg-[#06C755]/70 text-white/80 text-base font-semibold press-effect transition-all disabled:opacity-50"
            >
