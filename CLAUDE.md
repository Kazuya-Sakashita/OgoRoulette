...
- 現スコア: **70/100**（2026-04-06）— G-STACK:10 HEART:14 AARRR:11 Kano:7 感情:14 技術:14
- **感情 14/20 < 15 → 演出優先ルール発動中**

**ISSUE**
- 「なんとなく足りない」はISSUE化しない。スコアの数値が根拠になって初めてISSUE化する
- 次着手順（演出優先）: ISSUE-210 → ISSUE-212 → ISSUE-213 → ISSUE-211 → ISSUE-214 → ISSUE-215
