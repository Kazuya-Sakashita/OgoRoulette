...
- 完了済み: ISSUE-208〜209・214・221〜243・244〜259・260・263〜266〜276・278〜279・282・284・286・288・289（2026-04-18時点）
- 部分対応: ISSUE-281（join flow制約でメンバー強制不可）・287（ランキングログ追加）
- 未対応（設計フェーズ）: ISSUE-277（分散レートリミット）・280（CSP手動検証）・283（use-spin分割）・285（sendBeacon復旧）（2026-04-18 時点）
