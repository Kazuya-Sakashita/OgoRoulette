...
- 完了済み: ISSUE-208〜209・211・214・219・221〜243・244〜259・260・263〜266〜276・277・278〜279・282・283・284・286・288・289・290・291・292（2026-04-19時点）
- 部分対応: ISSUE-215 Phase 1a（Nudge+プランページ完了、Stripe Phase 1b は保留）・ISSUE-281（join flow制約でメンバー強制不可）・287（ランキングログ追加）
- 未対応（設計フェーズ）: ISSUE-280（CSP手動検証）・285（sendBeacon復旧）（2026-04-18 時点）
- 未対応（実装可能なもの）: なし（2026-04-18 時点）
